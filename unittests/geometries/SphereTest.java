...
class SphereTest {
    ...
    void findIntersectionsTest() {
        ...
        Ray r1=new Ray(new Point(-4,0,0),new Vector(4,0,2));
        ...
        assertTrue(expectedResult1.contains(new Point(0,0,2))
                && expectedResult1.contains(new Point(-1.6,0,1.2)),
                "Intersection Points not as expected for basic Ray-Sphere intersection");


        //TC02: Ray begins in Sphere (has 1 intersection)

        Ray r2=new Ray(new Point(-1,0,0),new Vector(1,0,2));
        ...
        Ray r4=new Ray(new Point(3,0,0),new Vector(0,1,0));
        ...
        Ray r5=new Ray(new Point(-2,0,0),new Vector(2,0,2));
        ...
        //Check that the List has the expected Point
        assertTrue(expectedResult5.contains(new Point(0,0,2)),
        ...
        Ray r7=new Ray(new Point(-2,0,0),new Vector(-1,0,0));
        ...
        Ray r8=new Ray(new Point(-3,0,0),new Vector(-1,0,0));
        ...
        Ray r9=new Ray(new Point(-0.5,0,0),new Vector(-1,0,0));
        ...
        //Check that the List has the expected Point
        assertTrue(expectedResult11.contains(new Point(-2,0,0)),
        ...
        Ray r12=new Ray(new Point(3,0,0),new Vector(-1,0,0));
        ...
        assertTrue(expectedResult12.contains(new Point(-2,0,0))
                        &&expectedResult12.contains(new Point(2,0,0)),
        ...
        Ray r13=new Ray(new Point(2,0,0),new Vector(0,0,3));
        ...
        Ray r14=new Ray(new Point(2,0,-1),new Vector(0,0,4));
        ...
        Ray r15=new Ray(new Point(2,0,1),new Vector(0,0,2));
        ...
        Ray r16=new Ray(new Point(3,0,0),new Vector(0,0,1));
        ...
        Ray r17=new Ray(new Point(1,0,0),new Vector(0,0,1));
        ...
        //Check that the list has the expected Points
        assertTrue(expectedResult17.contains(new Point(1,0,sqrt(3))),
